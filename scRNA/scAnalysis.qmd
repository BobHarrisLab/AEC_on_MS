...
#For cellbender processed data
DATA <- Read_CellBender_h5_Mat(file_name = "../data/cell/sc1_cellbender_filtered.h5")

#For Cellranger processed data
DATA <- Read10X_h5("../data/cell/sample_filtered_feature_bc_matrix.h5")
...
pdf("Brain_CD45/PBS_QC.pdf", width = 15, height = 8)
...
pdf("../Brain_CD45/Integration.pdf", width = 10, height = 6)
...
write.csv(top25, file = "../Major_Markers_top25.csv")
write.csv(detable_all, file = "../Major_Markers_All.csv")
...
pdf("../Results/Brain_CD45/Celltypes.pdf", width = 8, height = 4.5)
...
And subtypes for other cells was made in the same way. 
